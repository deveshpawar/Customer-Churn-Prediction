...
def main():
	...
	st.sidebar.info('Telecom Customer Churn Predictor')
	...
	if add_selectbox == 'Online':
		...
		contract= st.selectbox(" Type of Customer's contract?", ['month-to-month', 'one_year', 'two_year'])
		...
		if st.button("Predict"):
			...
			output = bool(churn)
		st.success('Churn: {0}, Churn Risk Score: {1}'.format(output, output_prob))
